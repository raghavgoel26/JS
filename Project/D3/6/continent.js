...
arr[0].conti="North America";

for(i=0;i<json.length;++i)
{
if(json[i]["Country Name"]=="Canada"||json[i]["Country Name"]=="Mexico" ||json[i]["Country Name"]=="USA")
{
arr[0].pop+=parseFloat(json[i][column1]);
arr[0].gdp+=parseFloat(json[i][column2]);
}
}

arr[1].conti="South America";

for(i=0;i<json.length;++i)
{
if(json[i]["Country Name"]=="Argentina"||json[i]["Country Name"]=="Brazil")
{
arr[1].pop+=parseFloat(json[i][column1]);
arr[1].gdp+=parseFloat(json[i][column2]);
}
}
...
{
arr[2].pop+=parseFloat(json[i][column1]);
arr[2].gdp+=parseFloat(json[i][column2]);
}
}
...
{
arr[3].pop+=parseFloat(json[i][column1]);
arr[3].gdp+=parseFloat(json[i][column2]);
}
}
...
{
arr[4].pop+=parseFloat(json[i][column1]);
arr[4].gdp+=parseFloat(json[i][column2]);
}
}

arr[5].conti="Australia";

for(i=0;i<json.length;++i)
{
if(json[i]["Country Name"]=="Australia")
{
arr[5].pop+=parseFloat(json[i][column1]);
arr[5].gdp+=parseFloat(json[i][column2]);
}
}
